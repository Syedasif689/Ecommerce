...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/security.css">
...
<div class="container">
    ...
    <h1>Welcome,
        <%= ((com.ecommerce.model.User)session.getAttribute("user")).getName() %>
    </h1>

   <h3>Welcome to Online Store</h3>

    <p>
        Browse thousands of products, manage your orders,
